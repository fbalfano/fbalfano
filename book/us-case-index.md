...
American anchor cases, catalogued like the Canadian ones. Same status legend:
✅ verified · ⚠️ confirm exact reporter page before print · 🔶 frame with care
(exoneration / suppressed / depublished / no-appeal).

US citations were confirmed via Justia, FindLaw, CourtListener, Cornell LII, and
official court sites. Several free databases returned 403 to the automated
fetcher, so a few exact reporter pages (flagged ⚠️) should be eyeballed when you
pull the PDF - the case, court, and disposition are confirmed in every instance.
...
- **Link:** https://www4.courts.ca.gov/opinions/documents/G063674.PDF
- **Smoking gun:** Cold-case sexual assaults; court reached the merits and held
  abandoned semen carries no privacy interest, so IGG analysis is not a "search."
  One of the few rulings squarely on the technique's constitutionality. **Some
  sources call it "People v. Russo" - confirm the party name in the PDF.**

### *Golden State Killer* (People v. Joseph James DeAngelo) - 🔶 (NO appeal - sidebar only)
- **Status:** Guilty plea, Sacramento County Superior Court, 2020. No appellate
  decision - resolved by plea, appeal waived.
- **Link:** https://en.wikipedia.org/wiki/Joseph_James_DeAngelo
- **Smoking gun:** The case that launched forensic genetic genealogy (April 2018);
...
- **Smoking gun / caution:** A fatal high-speed crash (DUI manslaughter /
  ...
  braking, throttle) without a warrant; the court held there's a privacy
...
### The Device That *Almost* Testified - no-conviction-on-appeal sidebar 🔶
Real, famous, but none produced a conviction upheld on appeal - group as a
sidebar on the frontier of device evidence:
- **State v. Bates** (Arkansas, Amazon Echo) - charges dropped (nolle prosequi),
  2017. The landmark Alexa-warrant fight.
- **Anthony Aiello** (California, victim's Fitbit heart rate stopping at 3:28 p.m.
  during his visit) - died before trial, 2019.
- **State v. Compton** (Ohio, pacemaker data) - arson/insurance, *not* murder;
  died before trial, 2020.
- **State v. Crespo** (Florida, Amazon Echo) - convicted 2021, no appellate
  decision found.
- **State v. Verrill** (New Hampshire, Amazon Echo) - convicted 2024; appeal
  pending (No. 2024-0337); Alexa audio reportedly not decisive.
