# Citation Worklist - Download & Summarize

Your pull list. Grouped by the book's forensic themes. For each: **case name +
citation** (what you paste into CanLII / Justia / CourtListener / Google
Scholar), country, and a status flag telling you what to double-check when the
PDF opens.

**Legend:** ✅ solid · ⚠️ confirm exact reporter/URL when you open it · 🔶 frame
with care (exoneration, suppressed, depublished, no-appeal, or contested).
**🇨🇦** CanLII · **🇺🇸** Justia/CourtListener/FindLaw/Scholar.

Suggested order: start with the ✅ cases (fastest to pull and cleanest to
summarize), then the ⚠️ ones where you'll verify the page number, then the 🔶
cases we'll frame carefully.
...
- ✅🔶 🇨🇦 *Truscott (Re)*, 2007 ONCA 575 *(entomology + pathology exoneration; CLOSING chapter)* - **text pulled ✔ (MD) · chapter drafted ✔**
...
2. The **one forensic thread** that caught them - explained accessibly.
3. The key passage(s) from the decision setting out the factual matrix.
4. The "how did they get caught?" payoff line.
5. Confirmation the citation/link is correct (you'll have the PDF open).
